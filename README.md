...
This library provides a [dumb](src/chpill/sonde.clj) macro that does it for you:
...
to `require` first, you may be interested in the
`chpill.sonde/dummy-nrepl-middleware`. If you are using Emacs with Cider, you
may want to put this in your `.dir-locals.el` or `.dir-locals-2.el`:

```
((nil . ((eval . (progn
                   (make-variable-buffer-local 'cider-jack-in-nrepl-middlewares)
                   (add-to-list 'cider-jack-in-nrepl-middlewares "chpill.sonde/fake-nrepl-middleware"))))))
```
